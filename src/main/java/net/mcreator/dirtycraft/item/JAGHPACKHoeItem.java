...
public class JAGHPACKHoeItem extends DirtycraftModElements.ModElement {
	@ObjectHolder("dirtycraft:jaghpack_hoe")
	public static final Item block = null;

	public JAGHPACKHoeItem(DirtycraftModElements instance) {
		super(instance, 5);
	}
