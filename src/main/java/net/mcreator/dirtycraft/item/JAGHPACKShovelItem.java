...
public class JAGHPACKShovelItem extends DirtycraftModElements.ModElement {
	@ObjectHolder("dirtycraft:jaghpack_shovel")
	public static final Item block = null;

	public JAGHPACKShovelItem(DirtycraftModElements instance) {
		super(instance, 4);
	}
