...
public class JAGHPACKSwordItem extends DirtycraftModElements.ModElement {
	@ObjectHolder("dirtycraft:jaghpack_sword")
	public static final Item block = null;

	public JAGHPACKSwordItem(DirtycraftModElements instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("jaghpack_sword"));
	}
}
